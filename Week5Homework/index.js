...
const user9 = toDos.filter(task => task.userId === 9)
console.log(user9)

  //- then find the number of user 9's incomplete tasks  
const user9Tasks = user9.filter(tasks => tasks.completed === false)

const numIncomplete = user9Tasks.reduce((total, tasks) => total + !tasks.completed, 0)
...
const user5 = posts.filter(post => post.userId === 5)
console.log(user5)

  //- then, create a list of title and body pairs 
const titleBodyPairs = user5.map(user => {
